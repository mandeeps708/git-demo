...
<<<<<<< HEAD
%\end{example}%------------------second numerical example-----------------%
\textbf{Example 12.2. Rectangular sloped footing of Type ($c$).}\\
\textbf{Given:}
Same as in Ex. 12.1 with
...
$$a = 40 \cmmacro$$
$$b = 60 \cmmacro$$ 
>>>>>>> 33790b809874e45c8ceafec7ec55b333e930d3af
and the footing is to have equal overhangs on all sides of column.\\
\textbf{Required:} Design the footing\\
\textbf{Solution:}
...
\begin{sagesilent}
  ...
  m20(A_st,B)=100*A_st/B
  q41 = m20(A_st,B)
  q42 = m20(q40,q10).n(digits=2)
...
\end{sagesilent}
   ...
   $$B = \sage{q10},D = \sage{q30}, D_m = \sage{q15}, b = \sage{bb}$$
   ...
   $$A_{st}(min)=0.12\times \sage{q44} = \sage{q46} cm^2/m$$
