...
\begin{sagesilent}
  ...
  m200(dia,qqq) = (3.14*((dia)^2))/(qqq*4)
  q200 = m200(dia,qqq)
  q201 = m200(diaa,q199)
  q201 = int(q201)

  m201(dia,qqq) = (3.14*((dia)^2)*1)/(4*qqq)
  q202 = m201(dia,qqq)
  q203 = m201(diaa,q201).n(digits=3)
\end{sagesilent}
...
\end{sagesilent}
 ...
 \equmacro (\ref{eq:ultimatemoment22c}) gives,
  ...
  $$k = 1.0,  {\tau_a} = {\tau_c} = \sage{tau_c} kN/cm^2 > {\tau_u}=0.034 kN/cm^2,$$
  $$D = \sage{q30} \text{cm is safe in beam shear}$$  
  
\item  \textbf{Check on development length of footing bars}\\
\tablemacro (11.3)gives for $\phi$ 12 bars

$$L_d (tension) = \sage{q68} = \sage{q69} cm$$
...
$$y = \sage{q70} = \sage{q71} cm > 66 cm \text{ OK,}$$
\end{enumerate}
