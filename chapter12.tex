...
Where, $fck$ is to be put in $N/m^2$ .\\
 $ks$ = 1.0 for square columns and also for rectangular with aspect ratio  $\left( \frac{b}{a} \right)$ $\leq {2.0}$. For the condition $T_v$ = $Ta$, equation \ref{eq:(1.2)} and \ref{eq:(1.4)} give,
...
The calculated steel area should not be less than the spec1ﬁed minimum steel area (Table 11.4 of Chapter 11)
