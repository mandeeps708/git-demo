...
$$M_{1-1} = \sage{s12} = \sage{s13.n(digits=4)} \knpms$$
...
\eqn \ref{eq:concretesolidslabs} gives,                            
        $$\sage{tau_a}=\sage{tau_c}=0.32 \knpms$$                      
With                                                                    
...
\end{sagesilent}
 ...
 \eqn (\ref{eq:ultimatemoment22c}) gives,
  ...
  \tablem 19 gives ${\tau_c}$ = 0.35 \text{$kN/cm^2$}
  $$k = 1.0,  {\tau_a} = {\tau_c} = \sage{tau_c.n(digits=3)} kN/cm^2 > {\tau_u}=0.34 kN/cm^2,$$
...
$$y = \sage{q70} = \sage{q71} cm > \sage{q69} cm \text{ OK,}$$
\end{enumerate}
