...
\end{enumerate}
The \citetitle{IS2000} requires footings to be designed for the following limit states.
...
at 150 $\cm$, the specified minimum given by the \citetitle{IS2000}. The depth ($D$) of
...
\end{sagesilent}
 ...
 \eqn (\ref{eq:ultimatemoment22c}) gives,
  ...
  \tablem 19 gives ${\tau_c}$ = 0.035 \text{$kN/cm^2$}
